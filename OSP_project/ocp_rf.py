...
target_columns = ['_id','field/name','language','learning_outcomes']
new_df = df.copy()
new_df = new_df[target_columns]

new_column_names = {'_id':'id','field/name':'field_name','language':'language','learning_outcomes':'learning_outcomes'}
...
features = pd.concat([xform_data.reset_index(drop=True), new_df[category_columns]], axis=1)
...
write_pickle(clf, out_path, 'xform_cv')
